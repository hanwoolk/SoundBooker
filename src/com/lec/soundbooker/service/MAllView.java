...
public class MAllView implements Service {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		request.setAttribute("mList", mDao.getAllMemberList(startRow, endRow)); // list.jsp에 출력될 글목록
		int totCnt = mDao.getAllMemberTotCnt(); //글 갯수
